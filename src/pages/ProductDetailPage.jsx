...
//           setSelectedImage(foundProduct.imageURL[0]); // Set first image
//         } else {
...
//   if (!product) {
//     return <div className="text-center text-red-500">Loading product details...</div>;
//   }
...
//         {/* Product Details */}
//         <p className="mt-3 text-lg"><strong>Size:</strong> {product.size || "N/A"}</p>
//         <p className="text-lg"><strong>Color:</strong> {product.color || "N/A"}</p>
//         <p className="text-lg"><strong>Material:</strong> {product.material || "N/A"}</p>
